...
// something other than the Desktop Chrome default the suites run under.
 ...
 * desktop width the suite started at (the Desktop Chrome default in the shared Playwright config).
 *
 ...
 * viewport in the test title keeps them apart (see {@link forEachViewport}).
 */
